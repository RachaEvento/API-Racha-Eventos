        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerParticipant = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventCosts_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHalfPrice = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventParticipants", x => new { x.EventId, x.ContactId });
                    table.ForeignKey(
                        name: "FK_EventParticipants_Contacts_ContactId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventCosts_EventId",
                table: "EventCosts",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventParticipants_ContactId",
