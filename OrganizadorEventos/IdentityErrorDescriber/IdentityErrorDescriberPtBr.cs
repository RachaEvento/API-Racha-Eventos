...
namespace OrganizadorEventos.IdentityErrorDescriber;

public class IdentityErrorDescriberPtBr : Microsoft.AspNetCore.Identity.IdentityErrorDescriber
{
    ...
    {
        return new IdentityError
            { Code = nameof(LoginAlreadyAssociated), Description = "Já existe um usuário com esse login." };
    }
    ...
    public override IdentityError InvalidUserName(string userName)
    {
        return new IdentityError
        {
            ...
            Description = $"O nome de usuário '{userName}' é inválido. Apenas letras e números são permitidos."
        };
    }
    ...
    {
        return new IdentityError { Code = nameof(DuplicateRoleName), Description = $"A função '{role}' já existe." };
    }
    ...
    {
        return new IdentityError
            { Code = nameof(UserNotInRole), Description = $"O usuário não está na função '{role}'." };
    }

    public override IdentityError PasswordTooShort(int length)
    {
        return new IdentityError
            { Code = nameof(PasswordTooShort), Description = $"A senha deve conter pelo menos {length} caracteres." };
    }
    ...
    {
        return new IdentityError
            { Code = nameof(RecoveryCodeRedemptionFailed), Description = "Falha ao resgatar o código de recuperação." };
    }
}